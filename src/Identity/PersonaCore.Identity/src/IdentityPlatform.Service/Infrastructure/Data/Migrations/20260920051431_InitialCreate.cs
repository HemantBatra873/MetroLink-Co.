        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAreaId = table.Column<Guid>(type: "uuid", nullable: true),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    Code = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_organization_units_organization_units_ParentUnitId",
                        column: x => x.ParentUnitId,
                        principalTable: "organization_units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_organization_units_organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeAreaId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_memberships_areas_ScopeAreaId",
                        column: x => x.ScopeAreaId,
                        principalTable: "areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_memberships_organization_units_OrganizationUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_memberships_OrganizationUnitId",
                table: "memberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_memberships_ScopeAreaId",
                table: "memberships",
                column: "ScopeAreaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_organization_units_OrganizationId",
                table: "organization_units",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_organization_units_ParentUnitId",
                table: "organization_units",
                column: "ParentUnitId");
